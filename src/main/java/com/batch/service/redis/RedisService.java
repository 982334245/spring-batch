package com.batch.service.redis;
...
//		try {
//			redisTemplate.setValueSerializer((RedisSerializer<?>) SpringContextLoaderListener.getContext()
//					.getBean("jdkSerializationRedisSerializer"));
